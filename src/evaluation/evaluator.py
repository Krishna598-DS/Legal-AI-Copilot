# evaluator.py
# PURPOSE: Measure RAG system quality using RAGAS framework
# Day 10: Evaluation — proving our system works
...
from src.llm.rag_chain import build_rag_chain, format_docs
